...
export const en = {
  ...
  skillsReadonly: "Temporary / extension-owned skill; cannot be configured in settings",
  ...
  notifSkillReadonly: "This skill cannot be toggled in settings",
  ...
  pluginsVisionModelAuto: "Automatic (the plugin picks an available vision model)",
  ...
  pluginsVisionFallbackChoose: "Choose a fallback vision model",
  pluginsVisionFallbackAdd: "Add fallback model",
  pluginsVisionFallbackRemove: "Remove fallback model",
  pluginsVisionFallbackNoModels: "No configured vision models are available.",
