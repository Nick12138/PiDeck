...
export const en = {
  ...
  fileToggleTask: "Toggle task completion",
  fileDisconnected: "File saving is unavailable until this workspace reconnects.",
  fileChangedType: "The file on disk is no longer editable text. Local changes are retained.",
  fileUnsavedTitle: "Save changes before leaving?",
  fileSaving: "Saving…",
  fileSave: "Save file",
  fileDiscard: "Don't save",
  fileEditor: "File editor",
  fileZoomOut: "Zoom out",
  fileZoomIn: "Zoom in",
  fileFit: "Fit",
  fileOriginalSize: "Original size",
  fileMediaFailed: "Unable to preview this file",
  ...
  fileReloadDisk: "Reload from disk",
  fileOverwrite: "Overwrite disk version",
  fileOpen: "Open file",
  fileView: "File view",
  filePreview: "Preview",
  fileMixedLineEndings: "Mixed line endings. Editing will normalize them to {ending}.",
  fileEnableEditing: "Enable editing",
  fileDiskVersion: "On disk",
  fileLocalVersion: "Your changes",
  fileTooLarge: "Preview limit: text 1 MiB; images and PDF 8 MiB.",
  fileUnsupported: "This file format or text encoding is not supported.",
  fileConfirm: "Confirm",
  fileNormalizeConfirm: "Saving will use the predominant line ending throughout this file.",
  fileReloadConfirm: "Discard your unsaved changes and load the disk version?",
  fileOverwriteConfirm:
    "Replace the displayed disk version with your current changes? Further disk changes will require another confirmation.",
  commonCancel: "Cancel",
  commonRetry: "Retry",
  commonDone: "Done",
  commonCopied: "Copied",
  ...
  // Telegram workspace (read-only view over the plugin inbox)
  tgWorkspacesTitle: "Message workspaces",
  ...
  tgInstallCancel: "Cancel install",
  ...
  tgRenameTitle: "Rename Telegram workspace",
  tgRenameLabel: "Display name",
  tgRenamePlaceholder: "Telegram",
  tgRenameHint:
    "Display-name mapping only; the bot handle stays unchanged. Leave empty to restore the default.",
  tgSettingsTitle: "Telegram settings — {name}",
  tgSettingsTokenTitle: "Bot token",
  tgSettingsTokenCurrent: "Current token",
  tgSettingsBoundTitle: "Bound account",
  tgSettingsBoundLabel: "Bound",
  tgSettingsBoundId: "ID: {id}",
  tgSettingsBoundNone:
    "Waiting for the first message — the first user to send /start to this bot becomes its owner.",
  tgSettingsBridgeSwitch: "Bridge",
  tgSettingsDeleteButton: "Delete Bot",
  tgSettingsDeleteTitle: "Delete telegram workspace",
  tgSettingsDeleteBody:
    "This permanently removes telegram.json, the temp state, the workspace folder and every telegram-driven session. The plugin package stays installed. This cannot be undone.",
  tgSettingsDeleteConfirmAction2: "Delete",
  tgOptRich: "Rich (buttons/collapsible)",
  tgOptHtml: "Plain HTML",
  tgOptQuiet: "Quiet",
  tgOptThinking: "Thinking only",
  tgOptTools: "Tools only",
  tgOptVerbose: "Verbose",
  tgOptHiddenOption: "Hidden",
  tgOptAlways: "Always",
  tgOptInterval: "Interval",
  tgOptManual: "Manual",
  tgOptMirror: "Mirror",
  tgOptRenderingHint:
    "How bot messages are rendered: Rich Messages (buttons, collapsible sections) or plain HTML.",
  tgOptActivityHint:
    "How much of the agent's work shows in Telegram: thinking blocks, tool calls, or both.",
  tgOptTimeInjectionHint:
    "Whether each request carries the current time; interval injects on a schedule instead of always.",
  tgOptProactivePushHint: "Push progress to Telegram while local/autonomous follow-up work runs.",
  tgOptReplyModeHint:
    "Voice reply policy: manual default, mirror voice input, or always synthesize.",
  tgOptAutoCleanupHint: "Automatically clean up telegram thread messages after a session ends.",
  tgSettingsConfigSave: "Save options",
  tgSettingsConfigSaved: "Options saved.",
  tgSettingsConfigSaveFailed: "Failed to save options.",
  tgSettingsBridgeHint: "Commands are pre-filled into the composer; press Enter to run them.",
  tgSettingsDangerTitle: "Danger zone",
  tgSettingsDangerHint:
    "Removes the bot profile, plugin config, workspace folder and all telegram sessions. The plugin package stays installed.",
  tgSettingsDelete: "Delete telegram workspace",
  tgSettingsDeleteConfirm: "Delete the entire telegram workspace?",
  tgSettingsDeleteConfirmHint:
    "This permanently removes telegram.json, temp state, the workspace folder and every telegram-driven session. This cannot be undone.",
  tgSettingsDeleteConfirmAction: "Delete everything",
  tgSettingsTokenSave: "Save",
  tgSettingsTokenValidated: "Validated: {bot}",
  tgSettingsTokenSaved: "Token saved. Send /telegram-connect to apply.",
  tgSettingsOptionsTitle: "Plugin options",
  tgOptRendering: "Rendering",
  tgOptActivity: "Activity detail",
  tgOptTimeInjection: "Time injection",
  tgOptProactivePush: "Proactive push",
  tgOptReplyMode: "Voice reply mode",
  tgOptAutoCleanup: "Auto thread cleanup",
  tgOptDefault: "Default",
