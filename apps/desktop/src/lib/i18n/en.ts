...
export const en = {
  ...
  tgRenameHint: "Display-name mapping only; the bot handle stays unchanged. Leave empty to restore the default.",
  ...
  tgSettingsBoundNone: "Waiting for the first message — the first user to send /start to this bot becomes its owner.",
  tgSettingsBridgeSwitch: "Bridge",
  tgSettingsDeleteButton: "Delete Bot",
  tgSettingsDeleteTitle: "Delete telegram workspace",
  tgSettingsDeleteBody: "This permanently removes telegram.json, the temp state, the workspace folder and every telegram-driven session. The plugin package stays installed. This cannot be undone.",
  ...
  tgOptManual: "Manual",
  tgOptMirror: "Mirror",
  tgOptRenderingHint: "How bot messages are rendered: Rich Messages (buttons, collapsible sections) or plain HTML.",
  tgOptActivityHint: "How much of the agent's work shows in Telegram: thinking blocks, tool calls, or both.",
  tgOptTimeInjectionHint: "Whether each request carries the current time; interval injects on a schedule instead of always.",
  tgOptProactivePushHint: "Push progress to Telegram while local/autonomous follow-up work runs.",
  tgOptReplyModeHint: "Voice reply policy: manual default, mirror voice input, or always synthesize.",
  ...
  tgSettingsDangerHint: "Removes the bot profile, plugin config, workspace folder and all telegram sessions. The plugin package stays installed.",
  tgSettingsDelete: "Delete telegram workspace",
  tgSettingsDeleteConfirm: "Delete the entire telegram workspace?",
  tgSettingsDeleteConfirmHint: "This permanently removes telegram.json, temp state, the workspace folder and every telegram-driven session. This cannot be undone.",
