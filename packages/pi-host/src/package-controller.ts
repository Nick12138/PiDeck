 ...
 * settings vs process cwd, and on Windows a verbatim-prefixed or symlinked
 * workspace resolves differently from the stored agentDir-relative path. The
 * already-resolved installedPath matches the settings-side identity.
 */
